...
export default function MegaH5() {
  ...
  useEffect(() => {
    const loadGames = async () => {
      setLoading(true)
      try {
        const result = await getAllMegaH5Games()
        console.log('[MegaH5] Loaded:', result?.length || 0)
        if (result && result.length > 0) {
          setGames(result)
        }
      } catch (e) {
        console.error('[MegaH5] Error:', e)
      }
      setLoading(false)
    }
    loadGames()
    ...
    <div className="slot-page">
      <div className="marquee">
        ...
        <div className="marquee-text">
          <span>Telegram: @Team33 | MegaH5 Games</span>
        </div>
      </div>
      ...
      <div className="slot-content">
        <div className="provider-header">
          <img
            src="https://syarikatcuci.com/wp-content/uploads/2024/11/download.jpeg"
            alt="MegaH5"
