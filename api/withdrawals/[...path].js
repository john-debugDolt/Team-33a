// Vercel Serverless Function - Withdrawals API (with path)
...
export default async function handler(req, res) {
  ...
  const targetUrl = `${BACKEND_URL}/api/withdrawals/${apiPath}${queryString}`;

  console.log(`[Withdrawals] ${req.method} -> ${targetUrl}`);
